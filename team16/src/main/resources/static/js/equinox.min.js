! function(t) {
    ...
    var s = function(e, n) {
            ...
            s.append('<div class="month-label">' + e.format("MMMM YYYY") + "</div>"), s.append('<div class="calendar-actions"></div>'), t(".calendar-actions", s).append('<button type="button" class="prev btn btn-light">Previous</button> '), t(".calendar-actions", s).append('<button type="button" class="next btn btn-light">Next</button> '), t(".calendar-actions", s).append('<button type="button" class="today btn btn-light">Today</button> '), a.append(s);
        ...
        d = function(e) {
            var n = t('<a data-toggle="tooltip" title="' + e.data["data"] + '" class="modalCalendar event" ' + ("" != e.color ? 'style="border-color: ' + e.color + ';"' : "") + "></a>");
