...
function loadAdminInfoAllOK(admin) {
	...
	$("#phoneNumber").val(admin.phone);
	$("#insNumber").val(admin.insurance);
	...
	$("#editPhoneNumber").val(admin.phone);
	$("#editInsNumber").val(admin.insurance);
...
function passValidation(Password) {
	...
	if (pass != "" && newPass != "" && confirmedPass != ""
			&& $("#oldPassword").hasClass("is-invalid") == false
			&& $("#newPassword").hasClass("is-invalid") == false
			&& $("#confirmedPassword").hasClass("is-invalid") == false) {
				...
				function(e) {
					...
					if (firstName != "" && lastName != "" && country != ""
						...
						$
								.ajax({
									type : 'PUT',
									url : 'doctorApi/updateDoctorMyself',
									headers : {
